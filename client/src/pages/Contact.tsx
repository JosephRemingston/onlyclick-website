                ...
                {contactInfo.map((item, index) => (
                  <div key={index} className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      {item.info && <p className="text-[#636E72]">{item.info}</p>}
                      {item.socialLinks && (
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <AnimatedSection>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">How are your service providers verified?</h3>
                <p className="text-[#636E72]">
            ...
            <AnimatedSection>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Can I reschedule or cancel a service?</h3>
                <p className="text-[#636E72]">
