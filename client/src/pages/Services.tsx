      ...
      <section className="pt-32 pb-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#2D3436] dark:text-white">Our Services</h1>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {serviceCategories.map((category, index) => (
              <AnimatedSection
                key={index}
                className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 hover:-translate-y-1 transform transition-transform duration-300"
              >
                <div className="flex items-center justify-center w-16 h-16 bg-[#0984E3]/10 dark:bg-[#0984E3]/20 rounded-full text-[#0984E3] mb-6">
                  {category.icon}
                </div>
                <h3 className="text-xl font-semibold mb-4 text-[#2D3436] dark:text-white">{category.title}</h3>
                <p className="text-[#636E72] dark:text-gray-300 mb-6">{category.description}</p>
                
                <h4 className="font-medium text-[#2D3436] dark:text-gray-200 mb-3">Available Services:</h4>
                <ul className="space-y-2 mb-6">
                  {category.services.map((service, i) => (
                    <li key={i} className="flex items-center text-[#636E72] dark:text-gray-300">
                      <svg
                ...
                <Link href="/download">
                  <div className="inline-block px-6 py-2 bg-[#00B894]/10 dark:bg-[#00B894]/20 text-[#00B894] rounded-lg hover:bg-[#00B894]/20 dark:hover:bg-[#00B894]/30 transition-colors duration-300 font-medium cursor-pointer flex items-center">
          ...
          <div className="bg-[#0984E3] rounded-xl p-8 md:p-12 text-white">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <AnimatedSection>
                ...
                <Link href="/contact">
                  <div className="inline-block px-6 py-3 bg-white text-[#0984E3] rounded-full hover:bg-gray-100 transition-colors duration-300 font-medium cursor-pointer">
